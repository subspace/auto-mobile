...
import { WalletNavigator, WalletTabParamList } from "./WalletNavigator"
...
const AppStack = observer(function AppStack() {
  ...
  return (
    <Stack.Navigator
      ...
      initialRouteName={isAuthenticated ? "Wallet" : "Login"}
    >
      {!isAuthenticated ? (
        <>
          <Stack.Screen name="Login" component={Screens.LoginScreen} />
          <Stack.Screen name="SetupAutoId" component={Screens.SetupAutoIdScreen} />
        </>
      ) : (
        <>
